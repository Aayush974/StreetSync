...
const registerUser = async function (data) {
  try {
    const res = await axios.post(`https://streetsync-1.onrender.com/api/v1/user/register`, data, {
...
const loginUser = async function (data) {
  try {
    const res = await axios.post(`https://streetsync-1.onrender.com/api/v1/user/login`, data, {
...
const searchForVendors = async function () {
  try {
    const res = await axios.get(`https://streetsync-1.onrender.com/api/v1/user/searchVendors`, {
